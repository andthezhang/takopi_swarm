...
Fork of [banteg/takopi](https://github.com/banteg/takopi) with swarm orchestration additions for cross-topic agent management in Telegram.

Key additions in this fork:
- `takopi swarm topics ...` to list/status/ensure topic bindings
- `takopi swarm control send ...` for bot-plane control messages
- `takopi swarm trigger send ...` for trigger-plane ingress into the Takopi loop
